      ...
      <div className={styles.right}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.totalText}>
            <div className={styles.totalTextTitle}>Subtotal:</div>rs.{order.total}/-
          </div>
          <div className={styles.totalText}>
            <div className={styles.totalTextTitle}>Discount:</div>rs.0/-
          </div>
          <div className={styles.totalText}>
            <div className={styles.totalTextTitle}>Total:</div>rs.{order.total}/-
          </div>
